    ...
    callbacks: {
        cardNonceResponseReceived: function(errors, nonce, cardData) {
            if (errors) {
                ...
                document.getElementById("payment-status").innerHTML = "<ul>" + error_html + "</ul>";
                return;
            }
            document.getElementById("payment-status").innerHTML = "Nonce received: " + nonce;
            // Call the server with the nonce
            fetch('/process-payment', {
                ...
                if (data.success) {
                    ...
                    document.getElementById("payment-status").innerHTML = "Payment failed: " + data.error;
                }
            });
        }
    }
...
function purchaseProduct(productId, price) {
    document.getElementById('purchase-amount').value = price;
    openStoreModal();
}
